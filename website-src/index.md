...
- If you are an instructor/facilitator, please view the [instructor's
  notes](instructions/index.html).

- If you are an attendee, please view the [workshop website](workshop/index.html).
